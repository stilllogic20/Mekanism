...
public class RotaryCondensentratorRecipeCategory extends BaseRecipeCategory {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper, IIngredients ingredients) {
        if (recipeWrapper instanceof RotaryCondensentratorRecipeWrapper) {
            ...
            fluidStacks.init(0, !condensentrating, 134 - xOffset, 14 - yOffset, 16, 58, RotaryCondensentratorRecipeWrapper.FLUID_AMOUNT,
                  false, fluidOverlayLarge);
            if (condensentrating) {
                initGas(gasStacks, 0, true, 26 - xOffset, 14 - yOffset, 16, 58,
                      new GasStack(tempRecipe.getGasType(), RotaryCondensentratorRecipeWrapper.GAS_AMOUNT), true);
